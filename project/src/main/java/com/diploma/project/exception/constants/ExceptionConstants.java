...
public enum ExceptionConstants {
    ...
    NC009("ЕРДР не создан (в разделе «Создать карточку ЮЛ» , «Создать карточку ФЛ»)", BAD_REQUEST, ERROR),
    NA010("Не доступно для ручного ввода", BAD_REQUEST, ERROR),
    UT011("Тип выгрузки не соответствует файлам", BAD_REQUEST, ERROR),
